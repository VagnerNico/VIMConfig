...
"NERDTree always display hidden files
...
let &t_Cs = "\e[4:3m"
let &t_Ce = "\e[4:0m"
hi SpellBad gui=undercurl guifg=Red guisp=Red cterm=undercurl ctermfg=Red
hi CocUnderline gui=undercurl guisp=Red cterm=undercurl ctermfg=Red
